...
//
// This AIDL interface is part of the OpenVPN for Android external API and is, like the
// rest of the api package, exempt from the GPLv2 (see the upstream ics-openvpn project).
// It lets NX-VPN hand an inline .ovpn config to the user's installed "OpenVPN for Android"
// engine, which performs the actual tunnelling.
